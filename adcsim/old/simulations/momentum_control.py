...
from adcsim import integrators as it, transformations as tr, util as ut, \
...
for i in range(len(time) - 1):
    ...
    states[i+1] = it.rk4(st.state_dot_mrp, time_step, states[i], real_controls[i], inertia, inertia_inv)
